sap.ui.define([
    ...
    return BaseController.extend("com.anubhavtraining.sd.so.mysalesorderapp.controller.List", {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "com.anubhavtraining.sd.so.mysalesorderapp.view.ViewSettingsDialog",
                    controller: this
