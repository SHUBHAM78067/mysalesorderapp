		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "my sales order application",
									"targetURL": "#comanubhavtrainingsdsomysalesorderapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comanubhavtrainingsdsomysalesorderapp-display": {
								"semanticObject": "comanubhavtrainingsdsomysalesorderapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.anubhavtraining.sd.so.mysalesorderapp",
									"url": sap.ui.require.toUrl("com/anubhavtraining/sd/so/mysalesorderapp")
								}
							}
						}
					}
